...
Source0:  https://github.com/flowerysong/OpenARC/releases/download/v1.0.0/openarc-1.0.0.tar.gz
	
 
	
BuildRequires: make, libtool, gcc, autoconf, automake, libbsd, libbsd-devel, openssl, openssl-devel, jansson, jansson-devel, sendmail-milter, sendmail-milter-devel
...
%doc README.md %{name}/%{name}.conf.sample
...
#* Fri Sep 18 2024 flowerysong <test@test.com> - 1.0.0-0.21

#- Source changed from official (seemingly abandoned) project to flowerysong's fork.

#- Fixed or rejected well over 100 PR's on the official OpenARC project page.


* Mon Sep  2 2024 Miroslav SuchÃ½ <msuchy@redhat.com> - 1.0.0-0.20.Beta3
